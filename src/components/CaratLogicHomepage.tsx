  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {features.map((feature, index) => <Card key={index} className="carat-card">
                <CardContent className="pt-6">
      ...
      <section className="py-16 px-6 bg-muted/30">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {subscriptionPlans.map((plan, index) => <div key={index} className={`subscription-card ${plan.popular ? 'featured' : ''} relative`}>
                ...
                <Button className={`w-full ${plan.popular ? 'btn-luxury' : ''}`} variant={plan.popular ? "default" : "outline"}>
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="carat-card">
