  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">${totalCostPrice.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
          <p className="text-xs text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">${totalSellingPrice.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
          <p className="text-xs text-muted-foreground">
