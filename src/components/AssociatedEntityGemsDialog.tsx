...
interface AssociatedEntityGemsDialogProps {
  open: boolean;
...
export const AssociatedEntityGemsDialog = ({ open, onOpenChange, entityName, gems }: AssociatedEntityGemsDialogProps) => {
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-slate-50 p-3 rounded-lg">
              <p className="text-sm text-slate-600">Total Memo Stones</p>
          ...
          {gems.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-slate-600">No memo stones found for this entity</p>
            </div>
          )}
        </div>
      </DialogContent>
